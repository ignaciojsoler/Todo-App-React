...
const MainHero = () => {
    ...
    return (
        <div className='m-auto h-screen flex flex-col justify-around items-center pt-44 pb-28 px-6 sm:pl-80 sm:justify-center' >
            ...
            <Link className='bg-primary text-white text-center text-lg w-full py-6 rounded-full max-w-sm hover:text-purple-700 hover:bg-purple-400 active:bg-purple-700 active:text-white sm:w-52 sm:ml-4 transition-colors duration-150' to="/todo-app-react/Home">Get started</Link>
        </div>
    );
};
